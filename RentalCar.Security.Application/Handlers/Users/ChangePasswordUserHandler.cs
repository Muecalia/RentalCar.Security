...
namespace RentalCar.Security.Application.Handlers.Users
{
    public class ChangePasswordUserHandler : IRequestHandler<ChangePasswordUserRequest, ApiResponse<InputUserResponse>>
    {
        ...
        public ChangePasswordUserHandler(IUserRepository userRepository, ILoggerService loggerService)
        {
        ...
        public async Task<ApiResponse<InputUserResponse>> Handle(ChangePasswordUserRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await _userRepository.ChangePassword(user, request.OldPassword, request.NewPassword, cancellationToken);
